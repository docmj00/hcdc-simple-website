...
<body>
	...
	<nav class="navbar navbar-expand-lg sticky-top bg-light">
		<div class="container">
			<a class="navbar-brand" href="index.php">Holy Cross of Davao</a>
			...
			<div class="col-sm-8 mt-1">
                ...
                <?php 
					...
					elseif (isset($_GET['category'])) {
						...
						if ($count==0) {
							$_SESSION['errorMessage'] = "Sorry, there isn't any index regarding that category";
							reDirect('index.php');
						}
						else {
                ...
                <div class="card my-3">
			     	<div class="card-body">
						...
						<small class="float-right mt-1">Reviews: 
						<?php
						...
						<a href="index_full.php?id=<?php echo $row['id']; ?>" class="pull-right">
            	...
            	<div class="mt-1">
					...
					<div class="card my-3">
						<div class="card-body pb-0">
							<?php
								$query = mysqli_query($con, "SELECT * FROM posts WHERE id IN (SELECT postid FROM review GROUP BY postid ORDER BY COUNT(reviews) DESC) ORDER BY id LIMIT 0, 6");
								while($row = mysqli_fetch_assoc($query)){
							?>
							
							<div>
								<a href="index_full.php?id=<?php echo $row['id']?>" style="text-decoration: none;">
