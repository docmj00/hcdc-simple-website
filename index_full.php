...
<?php
	...
	if (isset($_POST['comnt'])) {
		...
		if (empty($name)) {
			...
			reDirect('index_full.php?id='.$postid);
		}
		elseif (empty($email)) {
		...
		elseif (strlen($reviews)>299) {
			...
			$query = mysqli_query($con, "INSERT INTO review VALUES ('', '$datetime', '$name', '$email', '$reviews', 'None', 'OFF', '$postid')");
			if ($query) {
...
<body>
	...
	<nav class="navbar navbar-expand-lg sticky-top bg-light">
		<div class="container">
			<a class="navbar-brand" href="index.php"><strong>Holy Cross of Davao City</strong></a>
				...
				<div>	
					<div class="card mx-auto">
						...
						<div>
							<?php 
								//APPROVED REVIEW
								$query = mysqli_query($con, "SELECT * FROM review WHERE postid='$postid' AND status='ON'");
							...
							<div class="card-body pb-0">
								<div class="media">
									<img class="align-self-start" style="max-width: 100px; margin-right:15px;" src="assets/images/user.png" alt="Reviewer">
						...
						<div class="card-body mx-sm-4">
							...
							<!-- COMMENT SECTION -->
							<form action="index_full.php?id=<?php echo $postid; ?>" method="POST">
								<div class="form-row">
