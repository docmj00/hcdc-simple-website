...
<?php
	if (isset($_POST['pdelete'])) {
		...
		if ($query) {
			...
			reDirect('deletepost_course.php?id=$id');
		}		
	}
 ?>
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="nav-collapse">	
				<ul class="navbar-nav ml-auto mr-auto">
					...
					<li class="nav-item active">
						<a class="nav-link text-secondary" href="course.php">Trend<span class="sr-only">(current)</span></a>
					</li>
					-->
					<li class="nav-item active">
	...
	<div class="container">
		...
		<div class="mt-4 mx-sm-5">
			...
			<div class="card">
		  		<div class="card-header h4 text-primary">Delete</div>
		  		<div class="card-body mx-sm-5">
		    		
		    		<form action="deletepost_course.php?id=<?php echo $id; ?>" method="POST">
