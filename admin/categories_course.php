...
<?php
	...
	if (isset($_POST['csubmit'])) {
		...
		if (empty($category)) {
			...
			reDirect('categories_course.php');
		}
		...
		elseif (strlen($category)>30) {
			...
			$publish = mysqli_query($con, "INSERT INTO catcourse VALUES ('', '$category', '$publisher', '$datetime')");
			if ($publish) {
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="nav-collapse">	
				<ul class="navbar-nav ml-auto mr-auto">
					...
					<li class="nav-item active">
						<a class="nav-link text-secondary" href="categories_course.php">Categories<span class="sr-only">(current)</span></a>
					</li>
					<li class="nav-item active">
		...
		<div class="mt-4 mx-sm-5">
			...
			<div class="card">
		  		...
		  		<div class="card-body mx-sm-5">
		    		...
		    		<form action="categories_course.php" method="POST">
				  		<h5 class="card-title h5">Category Name</h5>
				    	<input type="text" class="form-control" name="cname" id="ctitle" placeholder="Title Name">

					    <div class="row mt-4">
					    	<div class="col pr-2">
							<a href="dashboard_course.php" class="btn float-right btn-primary action-button btn-min-wt"> Dashboard</button> </a>
					    	</div>
					    	<div class="col pl-2">
