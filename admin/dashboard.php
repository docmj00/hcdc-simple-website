...
<body>
	...
	<header>
		<div class="container mg-top">
			<div class="pt-3 pb-1"><h3>Home | Dashboard</h3></div>
		</div>
	</header>
		...
		<div class="mt-4 mx-4">
			<div class="row col-lg-12 p-0 m-0">
				<div class="col-md-3 mb-2">
					<a href="posts.php" class="btn btn-primary btn-block"> <img class="mb-1 d-icon" src="../assets/icons/create.svg"> Add New</a>
				</div>
				<div class="col-md-3 mb-2">
				...
				<div class="col-md-3 mb-2">
					<a href="review.php" class="btn btn-success btn-block"> <img class="mb-1 d-icon" src="../assets/icons/checkmark.svg"> Approve Review</a>
				</div>
			</div>
		</div>
					 ...
					 <tr>
						...
						-->
					 	...
					 	<td class="text-center">
								...
								<?php
								$id = $row['id'];
								$count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM review WHERE postid='$id' AND status='ON'"));
								if ($count>0) {
								...
								<?php
								$id = $row['id'];
								$count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM review WHERE postid='$id' AND status='OFF'"));
								if ($count>0) {
						...
						<!--
					 	<td class="text-center"> <a href="../index_full.php?id=<?php echo $row['id'] ?>" target="_blank" > <span class="btn-sm btn-primary">Preview</span> </a> </td>
						-->
					 </tr>
					 </tbody>
